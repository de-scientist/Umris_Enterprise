...
const Services = () => (
  <section id="services" style={styles.section}>
    ...
    <p style={styles.description}>
      Need efficient and secure logistics? Umris Enterprise offers comprehensive services, from trucking and shipping to last-mile delivery, with route optimization, real-time order processing, and secure packaging for timely and reliable results.
    </p>
